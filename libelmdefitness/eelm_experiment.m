            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        ...
                        trashelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        ...
                        eelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax, EE.CR, EE.F, EE.npop, EE.itermax,EE.refresh, EE.strategy,EE.tolerance,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        ...
                        elm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        pcaelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        kelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        ldaelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        pcaldaelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        ielm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        em_elm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        pelm(train_data, test_data, 1, EE.nhidden, EE.nnbase, EE.wMin, EE.wMax,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
            ...
            if EE.multicore
                parfor it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
                        CCRTrain(it), MSTrain(it), CCRTest(it), MSTest(it),...
                        NumberofInputNeurons(it),NumberofHiddenNeurons(it),NumberofHiddenNeuronsFinal(it),NumberofOutputNeurons(it),InputWeight{it,1},OutputWeight{it,1}] = ...
                        opelm(train_data, test_data, 1, EE.nhidden, EE.nnbase,EE);
                end
            else
                for it = 1:EE.repeatfold
                    [TrainingTime(it), ConfusionMatrixTrain{it,1}, ConfusionMatrixTest{it,1},...
...
switch lower(EE.elmAlgorithm)
    ...
    case{'opelm','pcaelm','ldaelm','pcaldaelm','ielm','em_elm','pelm','trashelm','kelm'}
        EEStats.nhidden = EE.nhidden;
