...
function [TrainingTime, ConfusionMatrixTrain, ConfusionMatrixTest, CCRTrain, MSTrain, CCRTest, MSTest...
    ...
    trashelm(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction,  wMin, wMax,EE)
...
%http://iitk.ac.in/iil/mtba/tutorial.html
%las   itl   
resultbic = biclust(P, 'bayes');
